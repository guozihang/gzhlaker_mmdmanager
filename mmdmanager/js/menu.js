class GMenu {
    ...
    registerSecondLevel() {
        ...
        this.softManu.append(
            new nw.MenuItem({
                label: "Effekseer15Beta4",
                click: function () {
                    child_process.spawn(PathManager.SOFTPATH + "Effekseer15Beta4\\Effekseer.exe", { stdin: "inherent", cwd: "./", detached: true });
                },
            })
        );
        this.softManu.append(
            new nw.MenuItem({
                ...
                click: function () {
                    child_process.spawn(PathManager.SOFTPATH + "MikuMikuDance_V739\\MikuMikuDance.CHS.exe", { stdin: "inherent", cwd: "./", detached: true });
                },
            })
        );
        this.softManu.append(
        ...
        this.softManu.append(
            new nw.MenuItem({
                ...
                click: function () {
                    child_process.spawn(PathManager.SOFTPATH + "MikuMikuDance_V926_Bridge\\MikuMikuDance.exe", {
                        stdin: "inherent",
                        cwd: "./",
                        detached: true,
                    });
        ...
        this.softManu.append(
            new nw.MenuItem({
                ...
                click: function () {
                    child_process.spawn(PathManager.SOFTPATH + "MikuMikuDance_V926_BridgeRT\\MikuMikuDance.exe", {
                        stdin: "inherent",
                        cwd: "./",
                        detached: true,
                    });
        ...
        this.softManu.append(
            new nw.MenuItem({
                ...
                click: function () {
                    child_process.spawn(PathManager.SOFTPATH + "MikumikuDance_V931\\MikuMikuDance.exe", { stdin: "inherent", cwd: "./", detached: true });
                },
            })
        );
        this.softManu.append(
            new nw.MenuItem({
                ...
                click: function () {
                    child_process.spawn(PathManager.SOFTPATH + "MikuMikuDance_V931_DX11\\MikuMikuDance.exe", { stdin: "inherent", cwd: "./", detached: true });
                },
            })
        );
        this.softManu.append(
            new nw.MenuItem({
                ...
                click: function () {
                    child_process.spawn(PathManager.SOFTPATH + "MikuMikuDance_v932\\MikuMikuDance.exe", { stdin: "inherent", cwd: "./", detached: true });
                },
            })
        );
        this.softManu.append(
            new nw.MenuItem({
                ...
                click: function () {
                    window.child_process.exec("explorer.exe" + " " + PathManager.SOFTPATH + "PMM_V2_Path_Editor\\pmm.exe");
                },
            })
        );
        this.softManu.append(
        ...
        this.softManu.append(
            new nw.MenuItem({
                ...
                click: function () {
                    child_process.spawn(PathManager.SOFTPATH + "PmxEditor_0254f_EN\\PmxEditor_x64.exe", { stdin: "inherent", cwd: "./", detached: true });
                },
            })
        );
        this.softManu.append(
