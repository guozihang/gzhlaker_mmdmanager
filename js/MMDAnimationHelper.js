...
var CCDIKSolver = THREE.CCDIKSolver;
// MMDPhysics is optional — only needed if physics is enabled
var MMDPhysics = typeof MMDPhysics !== 'undefined' ? MMDPhysics : undefined;
...
class MMDAnimationHelper {
	...
	pose( mesh, vpd, params = {} ) {
		...
		if ( this.configuration.pmxAnimation &&
			mesh.geometry.userData && mesh.geometry.userData.MMD && mesh.geometry.userData.MMD.format === 'pmx' ) {
	...
	createGrantSolver( mesh ) {
		...
		if ( ! mesh.geometry.userData || ! mesh.geometry.userData.MMD || ! mesh.geometry.userData.MMD.grants ) return null;
	...
	_optimizeIK( mesh, physicsEnabled ) {
		...
		if ( ! mesh.geometry.userData || ! mesh.geometry.userData.MMD ) return;
	...
	_createCCDIKSolver( mesh ) {
		...
		if ( ! mesh.geometry.userData || ! mesh.geometry.userData.MMD || ! mesh.geometry.userData.MMD.iks ) return null;
...
window.MMDAnimationHelper = MMDAnimationHelper;
